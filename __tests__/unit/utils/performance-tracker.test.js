/**
 * PerformanceTracker Advanced Tests - Memory trends and reporting
 */

const PerformanceTracker = require('../../../src/utils/performance-tracker');

describe('PerformanceTracker - Advanced Analysis', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  });

  describe('analyzePerformanceTrends - Memory Analysis', () => {
    it('should detect decreasing memory trend', () => {
      const mockMetrics = [
        { duration: 1000, success: true, memoryUsage: { heapUsed: 5000000 } },
        { duration: 2000, success: true, memoryUsage: { heapUsed: 4000000 } },
        { duration: 1500, success: true, memoryUsage: { heapUsed: 3000000 } },
        { duration: 3000, success: true, memoryUsage: { heapUsed: 2000000 } },
        { duration: 2500, success: true, memoryUsage: { heapUsed: 1000000 } }
      ];
      
      const result = PerformanceTracker.analyzePerformanceTrends(mockMetrics);
      
      expect(result.memoryTrend).toBe('decreasing');
    });

    it('should detect stable memory trend', () => {
      const mockMetrics = [
        { duration: 1000, success: true, memoryUsage: { heapUsed: 3000000 } },
        { duration: 2000, success: true, memoryUsage: { heapUsed: 3100000 } },
        { duration: 1500, success: true, memoryUsage: { heapUsed: 2900000 } },
        { duration: 3000, success: true, memoryUsage: { heapUsed: 3050000 } },
        { duration: 2500, success: true, memoryUsage: { heapUsed: 3000000 } }
      ];
      
      const result = PerformanceTracker.analyzePerformanceTrends(mockMetrics);
      
      expect(result.memoryTrend).toBe('stable');
    });
    ...
    it('should return insufficient_data for small datasets', () => {
      ...
      expect(result.memoryTrend).toBe('insufficient_data');
    });
  });
