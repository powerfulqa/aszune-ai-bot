...
describe('Index Uncovered Paths', () => {
  ...
  describe('bootWithOptimizations', () => {
    ...
    it('should handle license validation failure', async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith('License validation failed - see above for details');
    });
  ...
  describe('registerSlashCommands', () => {
    ...
    it('should handle registration error', async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith('Error registering slash commands:', expect.any(Error));
    });
  });
  ...
  describe('Shutdown Handling', () => {
    it('should handle shutdown errors gracefully', async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith('Error shutting down web dashboard service:', expect.any(Error));
    ...
    it('should ignore duplicate shutdown signals', async () => {
      ...
      expect(logger.info).toHaveBeenCalledWith(expect.stringContaining('Shutdown already in progress'));
    });
  });
  ...
  describe('Error Handlers', () => {
    ...
    it('should handle uncaught exceptions', () => {
      ...
      expect(logger.info).toHaveBeenCalledWith(expect.stringContaining('Received uncaughtException'));
    });
  });
});
