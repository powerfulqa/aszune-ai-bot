...
describe('Enhanced Message Chunker', () => {
  ...
  test('preserves formatting for multiple source references', () => {
    const textWithMultipleSources =
      'First source (1) (https://example.com). ' +
