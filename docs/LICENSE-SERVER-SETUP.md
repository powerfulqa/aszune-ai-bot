...
> **⚠️ FEATURE FLAGGED**: The license server is currently **disabled by default** and behind feature
> flags. Enable with `ENABLE_LICENSE_SERVER=true` or `NODE_ENV=development`.
