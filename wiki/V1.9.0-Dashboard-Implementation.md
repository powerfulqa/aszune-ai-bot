...
This v1.9.0 write-up references the original `*-demo.html` dashboard pages. In later releases, these
were renamed to the non-demo pages:
...
- [Release Notes v1.9.0](../docs/release-notes/RELEASE-NOTES-v1.9.0.md) - Complete version notes
