...
function formatSocialMediaLinks(text) {
  try {
    ...
    const errorResponse = ErrorHandler.handleError(error, 'formatting social media links', { textLength: text?.length || 0 });
...
function formatYouTubeLinks(text) {
  try {
    ...
    const errorResponse = ErrorHandler.handleError(error, 'formatting YouTube links', { textLength: text?.length || 0 });
...
function formatStarsectorLinks(text) {
  try {
    ...
    const errorResponse = ErrorHandler.handleError(error, 'formatting Starsector links', { textLength: text?.length || 0 });
...
function fixLinkFormatting(text) {
  try {
    ...
    const errorResponse = ErrorHandler.handleError(error, 'fixing link formatting', { textLength: text?.length || 0 });
...
function formatAllUrls(text) {
  try {
    ...
    const errorResponse = ErrorHandler.handleError(error, 'formatting all URLs', { textLength: text?.length || 0 });
